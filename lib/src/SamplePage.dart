...
import 'package:myapp/src/SecondPage.dart';
          ...
          new Row(
            children: <Widget>[
              new Container(
                ...
                child: new Image(image: AssetImage("assets/images/avatar2.png"),),
              ),
              new Container(
            ...
            child: new Row(
              ...
              children: <Widget>[
                new CupertinoButton(
                    ...
                    minSize: 60.0,
                    child: new Image.asset("assets/images/share_wechat.png"),
                    onPressed: () {
                ...
                new Container(
                  ...
                  child: new CupertinoButton(
                      padding: EdgeInsets.zero,
                      minSize: 60.0,
                      child: new Image.asset("assets/images/share_qq.png"),
                      onPressed: () {
                        print("share to qq");
                      }),
                ),
